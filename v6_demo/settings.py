"""
Django settings for v6_demo project.
"""
...
DATATYPE_LOCATIONS.append('v6_demo.datatypes')
FUNCTION_LOCATIONS.append('v6_demo.functions')
SEARCH_COMPONENT_LOCATIONS.append('v6_demo.search_components')
...
SECRET_KEY = '$jwugh=wi*4$ftglp#fci9l6me9y^l%s11%51=y6t5jlw(jnv&'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = 'v6_demo.urls'

# a prefix to append to all elasticsearch indexes, note: must be lower case
ELASTICSEARCH_PREFIX = 'v6_demo'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'v6_demo.search_indexes.sample_index.SampleIndex',
...
WSGI_APPLICATION = 'v6_demo.wsgi.application'
