...
class SignupView(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            email_context = {
                "button_text": _("Register for Arches Demo"),
                "link": confirmation_link,
                "greeting": _(
                    "Thanks for registering for a user account for the Arches Demo Site! Once you complete the process, you will be able to edit and add data. Soon, you will also be granted access to view and make changes within the Arches Reference Data Manager. Check https://www.archesproject.org/demo for more details, including the refresh schedule for demo site data and user accounts."
                ),
                "second_greeting": _(
                    " Click on the button link below to confirm your email address and complete the registration process. You can use either your username or email address to login to the site."
                    ),
                "closing": _(
            ...
            msg = EmailMultiAlternatives(_("Welcome to Arches Demo Site!"), text_content, admin_email, [form.cleaned_data["email"]], bcc=["archesmailbox@gmail.com"])
